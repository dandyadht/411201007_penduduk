...
(1, 3173101, 'Dandy Adhitya', 'Laki-laki', '1999-05-21', 'DKI Jakarta', 'Jakarta Barat', 'Tanjung Duren Timur 4', 12, 5),
(2, 3173102, 'Udin', 'Laki-laki', '1998-02-05', 'DKI Jakarta', 'Jakarta Timur', 'Kalisari', 6, 4),
(3, 3173103, 'Ayame', 'Perempuan', '2008-01-01', 'DKI Jakarta', 'Jakarta Barat', 'Apartment Mediterania', 6, 2),
(4, 3173104, 'Tester', NULL, NULL, 'Jawa Barat', 'Bandung', 'PVJ', 11, 12),
(5, 3173105, 'Viona', 'Perempuan', '2003-08-05', 'Jawa Barat', 'Bekasi', 'Perumahan Bekasi', 1, 1),
(6, 3173106, 'Tachjim', 'Perempuan', '2000-12-21', 'DKI Jakarta', 'Jakarta Pusat', 'Kemayoran', 15, 10);
